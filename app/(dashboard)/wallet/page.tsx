      ...
      <div className="flex flex-col items-center justify-center px-4 py-6 space-y-6 pb-32">
        ...
        <div className="flex flex-wrap gap-2 justify-center max-w-sm">
          {mockDogBadges.adaCompliant && (
            <span className="inline-flex items-center gap-1.5 bg-emerald-500/20 text-emerald-200 px-4 py-2 rounded-full text-xs font-semibold border border-emerald-500/50">
